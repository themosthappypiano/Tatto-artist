        ...
        <div className="container mx-auto px-4 relative z-20 text-center -mt-24">
          ...
          >
            <div className="flex justify-center -mt-8 -mb-8">
              <img src="/images/hero-text-cropped.png" alt="Where Art Dreams Come True" className="h-48 md:h-80 lg:h-96 xl:h-[28rem] 2xl:h-[32rem] w-auto max-w-full mt-8 md:mt-0" />
            </div>
